...
public class StrukMain11 {
    Scanner sc = new Scanner(System.in);

    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        Struk11 stk = new Struk11(20);
        StrukMain11 main = new StrukMain11();
    ...
    public void pushPakaian(Struk11 stk) {
        char pilih;
        do {
            ...
            Struk11 d = new Struk11(noTra, tanggal, jumlah, total);
